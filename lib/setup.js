...
function isValidURL(url) {
    if (url.indexOf('https://mediaklikk.hu/video/') === 0 || url.indexOf('https://m4sport.hu/videok/') === 0) {
        return true;
    }

    return 'Az alkalmazás csak https://mediaklikk.hu/video/* és https://m4sport.hu/videok/ oldalakkal működik!';
}
